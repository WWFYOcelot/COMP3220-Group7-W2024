...
package com.example.finaltest2.testingclasses;

import com.example.finaltest2.CustomMapImage;
import com.example.finaltest2.GeocodingParser;
...
public class MapTest extends Application {
    ...
    private static final String apiKey = "AIzaSyBn5POt-ThaW903dR_6OuMuy2uJkH-nQfc";
